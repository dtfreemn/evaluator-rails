...
Administrator.create(first_name:'Meggan', last_name:'Gabbin', email:'counterboycott@tortoise.edu', organization: flatiron, password: '123')
User.create(first_name:'Torri', last_name:'Jedan', email:'transplace@ursoid.co.uk', organization: flatiron)
Administrator.create(first_name:'Charlie', last_name:'Llano', email:'chondritis@aerophone.edu', organization: flatiron, password: '123')
User.create(first_name:'Mason', last_name:'Noordam', email:'maritorious@whistling.org', organization: flatiron)
Administrator.create(first_name:'Mae', last_name:'Orone', email:'epicotyledonary@lollardize.net', organization: flatiron, password: '123')
...
Administrator.create(first_name:'Paige', last_name:'Vlach', email:'inciter@tacky.org', organization: flatiron, password: '123')
...
Administrator.create(first_name:'Marquita', last_name:'Holec', email:'sheenly@oviform.co.uk', organization: subway, password: '123')
...
Administrator.create(first_name:'Keven', last_name:'Lado', email:'monocystis@hotheaded.co.uk', organization: subway, password: '123')
